<template>
    <div>
        <el-form ref="pictureForm" :model="modelParams" size="small" label-width="80px">
            ...
            <el-form-item v-if="modelParams.upload == 2" key="networkPic" label="网络图片" :rules="rules.networkPic" prop="networkPic">
                <div class="d-flex">
                    ...
                    <!-- <el-button v-ls-loading plain class="extract" @click="extract">提取</el-button> -->
                </div>
...
// import { common } from '@/api/ModuleCommon'
