    ...
    <div class="d-inline-block">
        <div class="lsUpload">
            ...
            <div
                ...
                class="lsUpload__imgWarp flex-center position-relative"
                :class="[mult ? '' : 'mx-0',disabled?'':'cursor-pointer']"
                :style="uploadStyle"
                @click.stop="handleClickImg"
            >
                <!-- <el-image :src="$photoServer + tempUrl" :previewSrcList="setPreViewSrc()" class="lsUpload__img h-100" fit="contain" /> -->
                <ls-image
...
export default {
    ...
    data() {
        return {
            ...
            // multiple: typeof this.value == 'object' ? true : false, //false:单图，true：多图
    ...
    methods: {
        ...
        show() {
            if (!this.disabled) {
                this.$nextTick(() => {
                    this.$refs.dialogStore.showDialog()
                })
            }
        },
        //传递事件
