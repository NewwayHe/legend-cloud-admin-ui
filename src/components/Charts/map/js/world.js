...
;(function (root, factory) {
    ...
    echarts.registerMap('world', {
        ...
        features: [
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@Ɵ½íIir[ò\\¢Ö ÈOŢ~y@esQm'], encodeOffsets: [[1747, 43524]] },
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@guûƿcy¤«£ŇR§èöcĘÐOōiƃ͇͟ϟչȕů˃LǇԮZپǭ˪ôľʎǳʶ^ƜàÀ̈́ǀÝʔĔŨñ'], encodeOffsets: [[31287, -2457]] },
                properties: { name: 'Burundi', childNum: 1 }
            },
            {
                geometry: { type: 'Polygon', coordinates: ['@@ʦq̈ʣȋ˥wAá\\ğí£Í}©͋ʁw՝ɸ£̪ɯǉͫVtɴСºÿƞ˓°Ɠȼ̇{ȟ̆ۚɾèōЂ˘ƮڰêƸǅӨŁđͅ'], encodeOffsets: [[5831, 51994]] },
            ...
            {
                geometry: { type: 'MultiPolygon', coordinates: [['@@ɚʡuÐ'], ['@@çSƎ°å']], encodeOffsets: [[[-83322, 19814]], [[-81739, 20186]]] },
                properties: { name: 'Cayman Is.', childNum: 2 }
            },
            {
                geometry: { type: 'Polygon', coordinates: ['@@ѹÃýƌϵÙǧìƖRÀǮ֔ߖʶԩ̳Àȑ'], encodeOffsets: [[34821, 35907]] },
                properties: { name: 'N. Cyprus', childNum: 1 }
            },
            {
                geometry: { type: 'Polygon', coordinates: ['@@Ǩë϶ÚþƋѺÄÛ̍eׇͳҹƆōȌ_ňΊö'], encodeOffsets: [[33498, 36016]] },
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@˕п̩æٓčKצӰپ~zv|OȌŏÂ¸Ŭ®dAĺĤȤ˻xɳثѿıX¾ÙϬüǠõ'], encodeOffsets: [[44284, 11776]] },
            ...
            {
                geometry: { type: 'MultiPolygon', coordinates: [['@@ōY£ŦƈLjŗ'], ['@@ÛåĴƤý']], encodeOffsets: [[[162115, 6978]], [[141459, 9729]]] },
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@½ɸžŒɌǣࠤǖשiǻĕǭȴࢬAèŠˎîמʷήŴŕΛƟݻːŕƇѷÑiƗۃEĩ÷'], encodeOffsets: [[-17165, 13378]] },
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@ފʱŞȧ˃¡˟ĞùĿƧíƑƁĲͿɵʞʛĪļƈ˾ØԦÃ'], encodeOffsets: [[-79115, 18901]] },
                properties: { name: 'Jamaica', childNum: 1 }
            },
            { geometry: { type: 'Polygon', coordinates: ['@@ǻ¯`øǜ'], encodeOffsets: [[-2067, 50413]] }, properties: { name: 'Jersey', childNum: 1 } },
            {
                geometry: {
                    type: 'Polygon',
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@ķȤøÍŖøĤ£ǲ»ǢŸłEŶRÚ^́ǋɉŋĵ½'], encodeOffsets: [[78898, 35953]] },
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@ϧ̙ʫPҐ঒ˠ͌΄z¯ƃƦÉäǯʳʝòï͇ñ¤ƕƓŹ'], encodeOffsets: [[36730, 34235]] },
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@ɉkɛ̓Ñęʭ͝˒ƛ˴ŗˆȦĚψӢȊÈŀĀŰàȪðĤlZ֨ёîȕĹ±Ŀŵőǿϛǧ'], encodeOffsets: [[29335, -30849]] },
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@ţ̃ƍ½[}¿Q©R}nyZÝ`YĐɼ|¨¦ÐĠîĨYjNEMïz»È·ÊyǸõ'], encodeOffsets: [[6643, 50994]] },
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@аˏƖɇó͹ōI·ŹķġkʹǅwǵƱŷ¯©wԣeɉàȃ̂ÞԎƆ@¬ǔʂĎȐÑĒĶƠxB@Ɇ²ѼV'], encodeOffsets: [[22881, 43330]] },
            ...
            { geometry: { type: 'Polygon', coordinates: ['@@ŉíƀǸĿ'], encodeOffsets: [[14916, 36714]] }, properties: { name: 'Malta', childNum: 1 } },
            {
                geometry: {
                    type: 'MultiPolygon',
                    coordinates: [
            ...
            { geometry: { type: 'Polygon', coordinates: ['@@áŦŔƾ±ˣ'], encodeOffsets: [[137826, 7560]] }, properties: { name: 'Palau', childNum: 1 } },
            {
                geometry: {
                    type: 'MultiPolygon',
                    coordinates: [
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@÷iíkÏ@³RlÓì©Ģ¼XýіȾӨɒƠʀȿ·ͅľЅƱ͓Ƈ½'], encodeOffsets: [[52499, 25198]] },
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@Ͳ´ŻːVѺїʋēڧѸصƠZŀͯސµ'], encodeOffsets: [[-37993, -55363]] },
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@ȰԞ͡P]N¹^§ErŐÊŀƈĝĊ`øIÐ£byÇʕű˹ىĐƤćક͂ʓƪ Ɩт˴uŰǰt'], encodeOffsets: [[-91507, 14762]] },
            ...
            {
                geometry: { type: 'MultiPolygon', coordinates: [['@@ŝ¯©ƊȀƬÀƉ÷Ļ'], ['@@ýìĄRŋ']], encodeOffsets: [[[6820, 124]], [[7602, 1606]]] },
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@Ħ»eɛÄȧNˍóz}MwţkǳZŏǹGɯ^Ǐ´ǯłĿǔ¯ļÛNYlR̎ʈζĴŚņô ZGьȇvX'], encodeOffsets: [[32715, -26580]] },
            ...
            {
                geometry: { type: 'Polygon', coordinates: ['@@řԛӈ͝²ՓǸʽrႫÿIȺוŽßλŃϙ̨ǯͰĞцœǊƾڸˁͼĮüҢʗÄĠŠßĮլϻ͎Ą̈ßĂҾƉ΄'], encodeOffsets: [[923, 11258]] },
