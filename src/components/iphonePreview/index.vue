    ...
    >
        <slot name="head">
            <img
                ...
                style="width: 372px; top: 90px; left: 20px; height: 20px"
                :src="require(`@/assets/images/head-stausBar1.png`)"
            />
        </slot>
        ...
        <div
            ...
            @scroll="onScroll"
        >
            <div v-if="headStausBar" class="pt-20 w-100 h-100 position-absolute left-0 right-0"><slot name="screen"></slot></div>
            <slot v-else name="screen"></slot>
        </div>
        <div class="buttons">
            <span class="on-off" />
            <span class="sleep" />
