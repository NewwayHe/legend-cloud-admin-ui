...
import ModuleFinance from './ModuleFinance' // 财务管理
import ModuleGoods from './ModuleGoods' // 商品管理
import ModuleMarketing from './ModuleMarketing' // 营销管理
import ModuleStore from './ModuleStore' // 商城管理
import ModuleSystem from './ModuleSystem' // 系统设置
import ModuleUser from './ModuleUser' // 用户管理
import ModuleOrder from './ModuleOrder' // 订单管理
...
export const constantRoutes = [
    ...
    {
        path: '/h5Trim',
        component: () => import('@/views/ModuleTrim/h5Trim/index'),
        name: 'h5Trim',
        meta: { title: '新增H5装修' },
        hidden: true
    },
    {
        path: '/orderPrint',
        component: () => import('@/views/ModuleOrder/orderList/orderPrint'),
        name: 'orderPrint',
        meta: { title: '打印订单' },
        hidden: true
    },
