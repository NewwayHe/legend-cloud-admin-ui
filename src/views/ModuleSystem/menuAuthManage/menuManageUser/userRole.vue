                ...
                >
                    ...
                    <el-table-column label="状态">
                        <template slot-scope="scope">
                            ...
                            <span v-else class="status-veto">删除</span>
                        </template>
                    </el-table-column>
            ...
            <el-dialog :title="dialogForm.title" custom-class="dialog-form-small" :visible.sync="dialogForm.isVisible">
                ...
                >
                    ...
                    <el-form-item label="角色编码：" prop="roleCode">
                        <el-input v-model="dialogForm.formData.roleCode" placeholder="请输入角色编码" maxlength="50" />
                    </el-form-item>
                    ...
                    <el-form-item label="角色描述：" prop="roledesc">
                        <el-input v-model="dialogForm.formData.roleDesc" type="textarea" placeholder="请输入角色描述信息" maxlength="50" />
                    </el-form-item>
                </el-form>
...
export default {
    ...
    data() {
        return {
            ...
            url: {
                getData: '/user/admin/ordinary/role/page',
                update: '/user/admin/ordinary/role',
