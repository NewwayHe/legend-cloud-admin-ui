        ...
        <el-card :body-style="{padding:`20px 20px 10px 20px`}">
            ...
            <div class="search">
                <el-form :inline="true" :model="searchFilters" size="small">
                    <el-form-item label="角色名称"><el-input v-model="searchFilters.name" placeholder="请输入角色名称" /></el-form-item>
                    <el-form-item>
            ...
            <div class="table">
                <!--列表-->
                <el-row class="mb-20"><el-col><el-button type="primary" size="medium" @click="handleCreate">新增</el-button></el-col></el-row>
                <el-table
                    ref="multipleTable"
                    ...
                    <el-table-column label="关联用户">
                        <template slot-scope="scope">
                            <el-link :underline="false" type="primary">
                                <router-link :to="{ name: 'adminList', query: { roleName: scope.row.roleName } }">查看</router-link>
                            </el-link>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="操作" fixed="right" width="180">
                        <template slot-scope="scope">
                            <span class="table__action">
                                ...
                                <el-link
                                    v-if="scope.row.id != 1 && !scope.row.delFlag"
                                    :underline="false"
                                    type="primary"
