...
export function getLineFn(url, params = {}) {
    request
        ...
        .then((res) => {
            ...
            List.push(wordList, people, frequency, mpPeople, mpFrequency, miniPeople, miniFrequency, appPeople, appFrequency, h5People, h5Frequency)
            this.allList = List
            this.wordcloudList = wordcloud
        })
        .catch((e) => {
            catchUrl(e, url)
            this.tableListLoading = false
