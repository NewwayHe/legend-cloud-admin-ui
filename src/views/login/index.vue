...
<template>
	<div class="login-container">
		<el-form ref="loginForm" size="small" :model="loginForm" :rules="loginRules" class="login-form rounded-10" auto-complete="on" label-position="left">
			<div class="w-100 flex-center mb-40" v-loading="!systemConfigFinally">
				...
				/>
				<img style="width: 400px;height: 95px;" src="@/assets/images/login__logo.png" alt="" v-else-if="systemConfigFinally" />
				<div style="width: 400px;height: 95px;" v-else></div>
			</div>

			<el-form-item prop="principal">
				<span class="svg-container"><svg-icon icon-class="user" /></span>
				<el-input ref="username" v-model="loginForm.principal" placeholder="账号" name="username" type="text" tabindex="1" auto-complete="on" />
			</el-form-item>
