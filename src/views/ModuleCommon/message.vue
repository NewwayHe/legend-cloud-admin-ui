    ...
    <el-card v-loading="pageLoading" class="message" :body-style="{padding:`20px 20px 10px 20px`}">
		...
		<LsSticky :data="list">
			<el-row type="flex" justify="space-between" class="w-100 overflow-h py-10 mt-10 bg-white">
				...
				<pagination :current-page="page.curPage" :page-size="page.pageSize" :total="page.total" @size-change="pageSizeChange" @current-change="currentPageChange" />
			</el-row>
		</LsSticky>
