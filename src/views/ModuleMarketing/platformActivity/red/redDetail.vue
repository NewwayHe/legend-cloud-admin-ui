        ...
        <el-card>
            <el-form ref="form" :model="form" label-width="132px" size="small">
                ...
                <el-form-item :label="form.minPoint?'满减券：':'无门槛券：'">
                    <p v-if="form.minPoint">
                        满{{form.minPoint || "-"}}元减{{form.amount || "-"}}元
                    </p>
                    <p v-else>
                        减{{form.amount || "-"}}元
                    </p>
                            ...
                            <el-table :data="couponShopList" max-height="400px" border>
                                <el-table-column prop="shopAvatar" label="店铺头像" width="100">
                                    <template slot-scope="scope">
                                        <ls-image :src="scope.row.shopAvatar" :options="{w:'50',h:'50'}" :key="scope.row.shopId"></ls-image>
                                    </template>
                                </el-table-column>
                ...
                <el-form-item label="状态：">
                    ...
                    <el-form-item label-width="0"><receiveInfo :couponId="form.id"/></el-form-item>
            </el-form>
        </el-card>
    </section>
</template>
