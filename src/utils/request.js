...
service.interceptors.request.use(
    (config) => {
        ...
        config.headers['source'] = 'PLATFORM'
...
service.interceptors.response.use(
    ...
    (error) => {
        ...
        // Message({
        //     message: error.response.data.msg || '网络请求异常, 请检查您的网络设置后刷新重试!',
        //     type: 'error',
        //     duration: 5 * 1000
        // })
        return Promise.reject(error)
...
export const request = {
    ...
    request(med, url, params, data, headers, opt) {
        const requestParmams = {
            url,
            method: med,
            params: params,
...
// export const request = (params, options = { isShowMessage: true }) => {
//     return new Promise((resolve, reject) => {
